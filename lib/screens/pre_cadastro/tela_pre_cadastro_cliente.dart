...
class _TelaPreCadastroClienteState extends State<TelaPreCadastroCliente> {
  ...
  void _salvarPreCadastro() async {
    if (_formKey.currentState!.validate()) {
      ...
      // ATUALIZADO: Salva na tabela de pré-cadastros
      final novoPreCadastro = PreCadastrosCompanion.insert(
        ...
        numeroCliente: (_croController.text), // Usando CRO como NumeroCliente (Cod_SAP)
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(controller: _cpfCnpjController, decoration: const InputDecoration(labelText: 'CPF / CNPJ', border: OutlineInputBorder())),
              const SizedBox(height: 16),
